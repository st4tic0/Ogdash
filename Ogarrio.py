...
prod = prod_data(r'C:\Users\JULRODRI\Documents\apps\Ogarrio\data\DAILYPROD.csv')
st.cache(prod)
...
wells = prod_data(r'C:\Users\JULRODRI\Documents\apps\Ogarrio\data\ogarrio_wells.csv')
st.cache(wells)
